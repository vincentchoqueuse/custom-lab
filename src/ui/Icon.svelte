<script>
  // Minimal inline icon set (lucide-style strokes) — keeps the chrome free of
  // emojis and consistent with the shadcn/ui look. Static markup only.
  const ICONS = {
    ...
    dice: '<rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="8.2" cy="8.2" r="1" fill="currentColor" stroke="none"/><circle cx="15.8" cy="8.2" r="1" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="8.2" cy="15.8" r="1" fill="currentColor" stroke="none"/><circle cx="15.8" cy="15.8" r="1" fill="currentColor" stroke="none"/>',
    'rotate-ccw':
    ...
    'file-code':
      '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 12.5 8 15l2 2.5"/><path d="m14 12.5 2 2.5-2 2.5"/>',
    braces:
  ...
  let { name, size = 16, stroke = 2 } = $props();
</script>
