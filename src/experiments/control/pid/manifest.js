...
export default {
  ...
  params: {
    ...
    Kd: float('Kd', { description: 'derivative gain (on the filtered measurement)', min: 0, max: 5, step: 0.05, default: 1, precision: 2 }),
    sigma: float('σ', { description: 'measurement noise', min: 0, max: 0.05, step: 0.002, default: 0, precision: 3 }),
  ...
  groups: [
    { title: 'Controller', params: ['Kp', 'Ki', 'Kd'] },
    { title: 'Measurement', params: ['sigma'] },
  ],
  ...
  views: [
    ...
    view(
      ...
      line('output', {
        ...
        label: 'y(t)',
        overlays: [
          hline(() => 1, { color: '#EDB120', dashed: true, width: 1.6, label: 'setpoint' }),
          vline(() => 10, { color: '#D95319', dashed: true, width: 1.6, label: 'disturbance' }),
        ],
