...
export default [
  {
    id: 'close',
    title: 'Scene 1 · Closing the loop, and seeing what changes',
...
it moves ω₀ and not the real part of the poles.`,
  ...
  {
    id: 'faster',
    title: 'Scene 2 · Faster and less damped, in the same ratio',
    params: { w0: 1, m: 0.5, K: 4 },
    view: 'gain',
    visible: ['K'],
    lock: true,
...
information — the closed-loop phase is steeper.`,
  ...
  {
    id: 'resonance',
    title: 'Scene 3 · A well-behaved plant that starts to resonate',
...
property of the loop.`,
  ...
  {
    id: 'nichols',
    title: 'Scene 4 · The chart: reading the CLOSED loop on the OPEN one',
    params: { w0: 1, m: 0.5, K: 4 },
    view: 'black',
    visible: ['K'],
