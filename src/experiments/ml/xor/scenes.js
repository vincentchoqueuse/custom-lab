...
export default [
  {
    id: 'perceptron',
    title: 'Scene 1 · A straight line cannot do it',
    view: 'plane',
...
years.`,
  ...
  {
    id: 'two',
    title: 'Scene 2 · Two neurons settle it',
    view: 'plane',
...
that takes it out of there.`,
  ...
  {
    id: 'plateau',
    title: 'Scene 3 · The plateau, and why it frightens people',
    view: 'learning',
...
the same book.`,
  ...
  {
    id: 'seed',
    title: 'Scene 4 · The initial randomness decides',
    view: 'learning',
    params: { problem: 'xor', hidden: 2, act: 'tanh', lr: 0.5, epoch: 4000 },
    visible: ['hidden', 'act'],
