...
export default [
  {
    id: 'linear',
    title: 'Two linear layers make one',
    view: 'time',
...
curves, and the statline measures the gap.`,
  ...
  {
    id: 'dense',
    title: 'Dense: 16 384 weights and no structure left',
    view: 'spectrum',
...
matrix have nothing in common. Each is its own drawing, learned separately.`,
  ...
  {
    id: 'toeplitz',
    title: 'Toeplitz: 9 weights, and it is a filter',
    view: 'rows',
