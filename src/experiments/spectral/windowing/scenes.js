...
export default [
  {
    id: 'one-tone',
    title: 'Scene 1 · A single sinusoid',
    view: 'spectrum',
...
understood, the rest of the experiment follows from it.`,
  ...
  {
    id: 'two-tones',
    title: 'Scene 2 · Two lines, one width',
    view: 'spectrum',
...
observation, not to the signal.`,
  ...
  {
    id: 'zero-padding',
    title: 'Scene 3 · Zero-padding resolves nothing',
    view: 'spectrum',
...
going to 1024 separates them.`,
  ...
  {
    id: 'hidden-tone',
    title: 'Scene 4 · The line hidden under the lobes',
    view: 'spectrum',
...
−58 dB, reveals it. The window chooses what one is ALLOWED to see.`,
  ...
  {
    id: 'tradeoff',
    title: 'Scene 5 · Resolution against dynamic range',
    view: 'spectrum',
