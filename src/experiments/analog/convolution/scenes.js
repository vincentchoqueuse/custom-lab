...
export default [
  {
    id: 'slide',
    title: 'Scene 1 · Flip, slide, integrate',
...
then leaves. The lower curve should stay hidden for now.`,
  ...
  {
    id: 'triangle',
    title: 'Scene 2 · Two gates give a TRIANGLE',
...
rectangles. The harness checks the closed form to 1e-12.`,
  ...
  {
    id: 'widths',
    title: 'Scene 3 · Widths add, areas multiply',
...
triangle of the previous scene. A special case, not a separate one.`,
  ...
  {
    id: 'commute',
    title: 'Scene 4 · Which one gets flipped? (it makes no difference)',
    params: { sig: 'gate', ker: 'gate', a: 2, b: 0.5, t: 1 },
    view: 'overlap',
    visible: ['a', 'b'],
...
flips whichever of the two makes the drawing simpler.`,
  ...
  {
    id: 'rc',
    title: 'Scene 5 · The same integral is the charging of an RC',
