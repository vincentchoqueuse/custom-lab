...
export default [
  {
    id: 'samples',
    title: 'Scene 1 · The signal and its samples',
...
about the signal? The whole experiment answers it, in frequency.`,
  ...
  {
    id: 'copies',
    title: 'Scene 2 · The spectrum repeats itself',
    params: { signal: 'gauss', fe: 600, tau: 5 },
    view: 'periodize',
    visible: ['fe'],
...
the spectrum shrinks. It does not: the copies move closer.`,
  ...
  {
    id: 'overlap',
    title: 'Scene 3 · They overlap, and that is aliasing',
...
narrower spectrum — which is the same trade seen twice.`,
  ...
  {
    id: 'bandlimited',
    title: 'Scene 4 · The only genuinely band-limited signal',
...
one of the four sources that achieves it, the others having infinite tails.`,
  ...
  {
    id: 'dtft',
    title: 'Scene 5 · What the samples know',
